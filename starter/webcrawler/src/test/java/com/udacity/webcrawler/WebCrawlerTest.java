...
public final class WebCrawlerTest {
  ...
  static Stream<Class<?>> provideTestParameters() throws Exception {
    String crawlerImplementations = System.getProperty("crawlerImplementations");
    String[] names = new String[0];
    if (crawlerImplementations == null || crawlerImplementations.isEmpty()){
      crawlerImplementations = "com.udacity.webcrawler.SequentialWebCrawler com.udacity.webcrawler.ParallelWebCrawler";
      names = System.getProperty("crawlerImplementations",crawlerImplementations).split("\\s+");
    }else {
      names = System.getProperty("crawlerImplementations").split("\\s+");
    }
